  ...
  return (
    ...
    <Paper className={classes.root} variant="outlined">
      ...
      <Select
        ...
        >
          <option value="ETH" className={classes.select}>ETH</option>
          <option value="DAI" className={classes.select}>DAI</option>
          <option value="OCEAN" className={classes.select}>OCEAN</option>
        </Select>

    </Paper>
        <Typography variant="caption" display="block" className={classes.help} >Доступный баланс: 
            <strong className={classes.link}
                onClick={handleClick} 
            >THIS_IS_NUMBER </strong>
        {state.payType} </Typography>
    </>
  );
}
