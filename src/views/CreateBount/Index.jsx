        ...
        <>
            ...
            <Container maxWidth="md" className={classes.root}>
                <Paper className={classes.all}>
                    ...
                    <TextInfo header="Enter your details about this bounty." text="Enter a title and description for your bounty. A markdown preview will automatically be generated
                     ...
                     <div className={classes.controlWidt}>                         
                        <TextArea full={true} label="Description" id="desc" place="Enter description..." />         
                        <HelpTooltip 
                     ...
                     <TextInfo header="How should this bounty be classified?" text="Enter the categories and difficulty level for the bounty. Since difficulty
                    ...
                    <Divider />
                     ...
                     <Button variant="outlined" className={classes.btnFly}>Create</Button>
                     <Button variant="text" className={classes.btnFly}>Cancel</Button>
                     </form>
                </Paper>
            </Container>
        </>
