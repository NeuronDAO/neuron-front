...
export default function UserInfo(props) {
    ...
    function controlLine (str) {
        ...
        else if(str.length >= 70) {locLink = str.substr(0,10) + '...' + str.substr(str.length - 10, 10);}
        else {locLink = str;}

        return(<Chip className={classes.link} component="a" href={str} icon={<IconFile />} label={locLink} variant="outlined" />)
    ...
    function generationtext (str) {
        return(<Typography paragraph component="span" display="block" className={classes.text}> {str} </Typography>)
    }
    ...
    return (
          ...
          <List>
            ...
            <ListItem alignItems="flex-start" className={classes.listAll}>
                ...
                primary={<Button component={Link} to={userGo}> {props.uName} </Button>}
                secondary={
