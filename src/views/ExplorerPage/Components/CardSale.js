...
export default function CardSale (props) {
  ...
  return(
      <div className={classes.Area}>
          <div>
          <Typography className={classes.Usd} noWrap>{humanNumber(props.usd)} </Typography>
          <Typography className={classes.Eth} noWrap>{controlLenght(props.eth)} ETH</Typography>
          </div>
      </div>
  )
}
