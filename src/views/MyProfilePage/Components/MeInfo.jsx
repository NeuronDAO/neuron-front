...
export default function UserInfo() {
    ...
    return (
      <div className={classes.meMini}>
        ...
        <Typography variant="subtitle2">Сюда выводится текст описания, из графы "об омне". Раз уж мы её сделали, то должны вывести. 
        Да и к тому же посмотрим, как вытягивается пространство
        </Typography>
      </div>      
    );
  }