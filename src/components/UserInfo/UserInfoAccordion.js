    ...
    return (
        <Accordion className={classes.root}>
          ...
          <List className={classes.listAll}>
            <ListItem alignItems="flex-start" className={classes.listAll} >
              ...
              <ListItemText
                ...
                secondary={
                  <React.Fragment>
                    <Typography component={Link} variant="subtitle2" className={classes.hash}                        
          ...
          <AccordionDetails className={classes.accDop}>
            ...
            <UserLinks site="https://dolmatov.me/" twitter={false} github={false} linkedIn={false} telegram="dolmatov_s" />
